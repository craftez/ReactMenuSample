...
const ref = new Firebase('https://menucatchoftheday.firebaseio.com/');
...
class Inventory extends React.Component {
  ...
  authHandler(err, authData) {
    ...
    //save login token in the browser
  ...
  renderInventory (key) {
    ...
    return Object.keys(this.props.fishes).map((key) => {
      return  (
  ...
  render () {
    ...
    //then if they arent the owner of current store
